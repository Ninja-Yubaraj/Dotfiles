...
--              |__/     |_____|                            |__/ 
-- My xmonad configuration file. This is where I started out my WM journey.
...
myStartupHook = do
    ...
    --spawnOnce "mocp -S"                                                                              -- start music player
...
myKeys c =
  ...
  --, ("M-e w", addName "Emacsclient EWW Browser"  $ spawn (myEmacs ++ ("--eval '(doom/window-maximize-buffer(eww \"ninja-yubaraj.github.io\"))'")))]
  ...
  , ("<XF86HomePage>", addName "Open home page"       $ spawn (myBrowser ++ " https://ninja-yubaraj.github.io"))
